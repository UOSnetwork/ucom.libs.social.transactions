...
class TransactionFactory {
   ...
   * @param {boolean} asString - if true strignified JSON will be returned
   * @returns {Promise<Object>}
   */
  static async getSignedUserFollowsUser(senderAccountName, senderPrivateKey, recipientAccountName, asString = false) {
    const interactionType = InteractionTypesDictionary.getFollowId();

    const json = await this._getSignedUserToUser(senderAccountName, senderPrivateKey, recipientAccountName, interactionType);
  ...
  static async getSignedUserUnfollowsUser(senderAccountName, senderPrivateKey, recipientAccountName, asString = false) {
    ...
    const json = this._getSignedUserToUser(senderAccountName, senderPrivateKey, recipientAccountName, interactionType);
